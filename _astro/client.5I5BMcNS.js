...
function dt(e, n) {
  e.blockedOn === n &&
    ((e.blockedOn = null),
    ou ||
      ((ou = !0), he.unstable_scheduleCallback(he.unstable_NormalPriority, Yc)))
}
function It(e) {
  function n(l) {
    return dt(l, e)
...
var bf = Xe.ReactCurrentOwner,
  ae = !1
function le(e, n, t, r) {
  n.child = e === null ? na(n, null, t, r) : et(n, e.child, t, r)
}
...
function Pi(e, n, t, r, l) {
  ...
  if ((Gn(n, l), n.stateNode === null))
    xr(e, n), _a(n, t, r), ku(n, t, r, l), (r = !0)
  else if (e === null) {
    var o = n.stateNode,
      i = n.memoizedProps
    o.props = i
...
var Cd = qi.exports,
  ...
  ec,
  Ai = Cd
;(ec = Ai.createRoot), (ba = Ai.hydrateRoot)
...
function xd(e, n) {
  if (n && e) {
    ...
    r.innerHTML = e
    for (let l of r.content.children) t.push(nc(l))
    return t
...
const Hi = (e, n) => {
  ...
  Nd =
    ...
    (n, t, { default: r, ...l }, { client: u }) => {
      ...
      const o = e.getAttribute('data-action-key'),
        i = e.getAttribute('data-action-name'),
        s = e.getAttribute('data-action-result'),
        c = o && i && s ? [JSON.parse(s), o, i] : void 0,
        v = { identifierPrefix: e.getAttribute('prefix'), formState: c }
      for (const [g, w] of Object.entries(l))
        t[g] = Ae.createElement(Lo, { value: w, name: g })
      const m = Ae.createElement(
          n,
          t,
          xd(r, e.hasAttribute('data-react-children'))
        ),
        p = _d(e)
      if ((p && delete e[p], u === 'only'))
